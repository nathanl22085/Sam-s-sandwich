...
print(f"Your selected bread choice: {bread_choice}")
print(f"Your selected meat choice: {meat_choice}")
print(f"Your selected cheese choice: {cheese_choice}")
print(f"Your selected dressing choice: {dressing_choice}")
print(f"Your selected salad choices: {salad_choice}")